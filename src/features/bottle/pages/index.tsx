...
import Slide1 from "../images/imageSlidTwo.png"
...
import  from "../images/iconoir-color-filter.svg";
...
import powerUpIgniteVitalityElevatePerformance from "../images/iconoir-color-filter.svg";
...
const Slider = forwardRef<SliderHandle>((props, ref) => {
